...
/**
 * User interface using Java Swing for Dive Formula Calculator.
 *
...
public class DiveCalculatorGUI extends JFrame {
    ...
    /**
     * Method to Init radio Button and handle their logic.
     * Handle the enable disable spinner logic based on the radio selection.
     */
    private void initRadio() {
        ...
        radioMaximumOperatingDepth.addActionListener(e -> {
            ...
            //Make sure to only has enable the Spinner components that the Calculation needs.
    ...
    /**
     * Setting parameters for main Window
     */
